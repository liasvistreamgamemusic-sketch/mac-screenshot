...
// Renders a 1024×1024 master app icon: a rounded "squircle" with a blue→purple
// gradient and a white camera-viewfinder glyph. Usage:
//   swift generate_icon.swift <output.png>
...
let colors = [
    CGColor(red: 0.30, green: 0.45, blue: 0.98, alpha: 1.0),
    CGColor(red: 0.55, green: 0.30, blue: 0.95, alpha: 1.0)
] as CFArray
...
// White viewfinder glyph centred on the icon.
let symbolConfig = NSImage.SymbolConfiguration(pointSize: side * 0.5, weight: .regular)
